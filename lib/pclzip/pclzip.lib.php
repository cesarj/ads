  ...
  function privExtractFile(&$p_entry, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
  {
    ...
    // ----- Check the directory availability and create it if necessary
      ...
      if ((($p_entry['external']&0x00000010)==0x00000010) || (substr($p_entry['filename'], -1) == '/'))
        ...
        $chmodDir = ( isset($p_options[PCLZIP_OPT_SET_CHMOD]) ? $p_options[PCLZIP_OPT_SET_CHMOD] : 0777);

      if (($v_result = $this->privDirCheck($v_dir_to_check, (($p_entry['external']&0x00000010)==0x00000010), $chmodDir)) != 1) {
...
*/
  ...
  // --------------------------------------------------------------------------------
  function privDirCheck($p_dir, $p_is_dir=false, $p_chmod = 0777)
  {
    $v_result = 1;
    ...
    if ($p_parent_dir != $p_dir)
    {
      ...
      if ($p_parent_dir != "")
      {
        if (($v_result = $this->privDirCheck($p_parent_dir, true, $p_chmod)) != 1)
        {
          //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, $v_result);
          return $v_result;
        }
