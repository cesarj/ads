...
$GLOBALS['strTypeWebSize'] = "Maximum permitted banner size (KB)";
$GLOBALS['strTypeWebSizeTooLarge'] = "The maximum permitted banner size specified is larger than permitted by the PHP .ini file settings of: ";
$GLOBALS['strTypeWebSizeTooLargeReview'] = "Review your server's 'upload_max_filesize' and 'post_max_size' settings";
$GLOBALS['strTypeWebSizeWarnOnly'] = "Only warn users when banners exceed limits, rather than preventing uploads";
