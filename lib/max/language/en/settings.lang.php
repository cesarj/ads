...
$GLOBALS['strTypeWebWarnMaxSize'] = "Maximum banner size (KB) before advising users banner size should be reduced - if set, must be less than ";
$GLOBALS['strTypeWebWarnMaxSizeTooLarge'] = "The 'soft' maximum banner size specified is larger than permitted by the PHP .ini file settings of: ";
$GLOBALS['strTypeWebHardMaxSize'] = "Maximum banner size (KB) before banners will not be allowed to be uploaded - if set, must be no more than ";
$GLOBALS['strTypeWebHardMaxSizeTooLarge'] = "The 'hard' maximum banner size specified is larger than permitted by the PHP .ini file settings of: ";
$GLOBALS['strTypeWebMaxSizeTooLargeReview'] = "Review your server's 'upload_max_filesize' and 'post_max_size' settings";
$GLOBALS['strTypeWebWarnMaxSizeLarger'] = "The 'soft' maximum banner size specified need to be smaller than the 'hard' maximum banner size";
